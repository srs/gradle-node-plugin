    ...
    extends NpmTask
{
    public GruntInstallTask()
    {
        ...
        this.project.afterEvaluate {
            ...
            getOutputs().dir( new File( (File) this.project.node.nodeModulesDir, 'node_modules/grunt' ) )
            getOutputs().dir( new File( (File) this.project.node.nodeModulesDir, 'node_modules/grunt-cli' ) )
        }
    }
}
